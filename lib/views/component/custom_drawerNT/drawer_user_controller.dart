...
class DrawerUserControllerNT extends StatefulWidget {
  const DrawerUserControllerNT({
    Key? key,
    this.drawerWidth = 250,
    this.onDrawerCall,
    this.callBackPhongModel,
    this.screenView,
  ...
  final Function(DrawerIndexNT)? onDrawerCall;
  ...
  @override
  _DrawerUserControllerNTState createState() => _DrawerUserControllerNTState();
}

class _DrawerUserControllerNTState extends State<DrawerUserControllerNT> with TickerProviderStateMixin {
                ...
                child: AnimatedBuilder(
                  ...
                  builder: (BuildContext context, Widget? child) {
                    return Transform(
                      ...
                      child: HomeDrawerNT(
                          screenIndex: widget.screenIndex == null ? DrawerIndexNT.Home : widget.screenIndex,
                          iconAnimationController: iconAnimationController,
                          callBackIndex: (DrawerIndexNT indexType) {
                            onDrawerClick();
                            try {
                          ...
                          callBackPhongModel: (value) {
                            widget.callBackPhongModel!(value);
                          }),
                    );
                  },
                ),
                          ...
                          child: Material(
                            ...
                            child: InkWell(
                              ...
                              child: Center(
                                ...
                                child: widget.menuView != null ? widget.menuView : AnimatedIcon(color: isLightMode ? AppTheme.white : AppTheme.white, icon: widget.animatedIconData ?? AnimatedIcons.arrow_menu, progress: iconAnimationController!),
                              ),
                              onTap: () {
