...
class _HomeDrawerState extends State<HomeDrawer> {
  ...
  void setDrawerListArray() {
    drawerList = <DrawerList>[
      ...
      DrawerList(
        index: DrawerIndex.HoaDon,
        labelName: 'Hoá đơn',
        icon: Icon(Icons.paid),
      ),
      DrawerList(
        index: DrawerIndex.HopDong,
        labelName: 'Hợp đồng',
        icon: Icon(Icons.article),
      ),
      DrawerList(
        index: DrawerIndex.PhongTro,
        labelName: 'Phòng trọ',
        icon: Icon(Icons.room_service),
      ),
      DrawerList(
        index: DrawerIndex.DichVu,
        labelName: 'Dịch vụ',
        icon: Icon(Icons.dry_cleaning),
      ),
      DrawerList(
        index: DrawerIndex.CoSoVatChat,
        labelName: 'Cơ sở vật chất',
        icon: Icon(Icons.electrical_services_sharp),
      ),
      DrawerList(
        index: DrawerIndex.Nha,
        labelName: 'Nhà',
        icon: Icon(Icons.home),
      ),
      DrawerList(
...
enum DrawerIndex { Home, HoaDon, HopDong, PhongTro, DichVu, CoSoVatChat, Chat, Nha, Profile }
